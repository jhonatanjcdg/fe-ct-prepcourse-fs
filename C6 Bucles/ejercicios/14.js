function operadoresLogicos(num1, num2, num3) {
  ...
  // Tu código:
  return (num1<0|num2<0|num2<0)?"Hay negativos":(num1==0&num2==0&&num3==0)?"Error":(num1>num2&&num1>num3)?"Numero 1 es mayor y positivo":(num3>num2&&num3>num1)?num3+1:false
}
